...
//two initialization bytes 0b00000010 are necessary but causes error without full power reset to lcd.
	SET_E();
	LCD_SET_PORT(0b00000010);  //[B] To transfer 0b00100000 i was using LCD_DATA_PORT|=0b00100000
	_delay_us(0.5);
	CLEAR_E();
	_delay_us(0.5);
	...
	SET_E();
	LCD_SET_PORT(0b00001000); //[B] To transfer 0b00100000 i was using LCD_DATA_PORT|=0b00100000
	_delay_us(0.5);
	CLEAR_E();
	_delay_us(0.5);
